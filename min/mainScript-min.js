window.addEventListener('DOMContentLoaded',()=>{const allPosts=document.querySelectorAll('article.post-outer-container')
const featuredPosts=Array.from(allPosts).slice(0,2)
const cloneFeaturedPosts=[]
featuredPosts.forEach(post=>cloneFeaturedPosts.push(post.cloneNode(!0)))
