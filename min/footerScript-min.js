...
LabelUlLis.forEach((li,i)=>{if(i<8){finalLabelUl1.appendChild(li)}else if(i>=8&&i<16){finalLabelUl2.appendChild(li)}else if(i>=16&&i<=23){finalLabelUl3.appendChild(li)}})
...
lisSocialMedia.forEach(li=>{const arrayData=li.textContent.split('/')
